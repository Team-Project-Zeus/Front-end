          ...
          <form onSubmit={this.handleEdit}>
            ...
            <div className="agendCtrls-timePicker-wrapper">
              <div className="agendCtrls-time-picker">
                ...
                <p>{this.state.startDateTime.format("HH:mm")}</p>
              ...
              <div className="agendCtrls-time-picker">
                ...
                <p>{this.state.endDateTime.format("HH:mm")}</p>
...
ModifiedReactAgendaCtrl.propTypes = {
...
ModifiedReactAgendaCtrl.defaultProps = {
  items: [],
  itemColors: {},
  selectedCells: []
}

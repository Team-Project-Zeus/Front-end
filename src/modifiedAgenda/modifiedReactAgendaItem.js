...
//THIS IS THE ELEMENT THAT DISPLAYS ON THE AGENDA ITSELF
export default class ModifiedReactAgendaItem extends Component {
  ...
  render() {
    ...
    return <div onClick={() => this.props.edit(this.props.item)} style={this.state.wrapper} className="agenda-cell-item" onMouseEnter={this.raiseZindex} onMouseLeave={this.lowerZindex}>

      <div className="agenda-controls-item" style={this.state.controls}>
        {/* {this.props.edit?
                <div className="agenda-edit-event">
                  <a  className="agenda-edit-modele">
...
ModifiedReactAgendaItem.propTypes = {
...
ModifiedReactAgendaItem.defaultProps = {
  parent: 'body',
  item: {},
  padder: 0
}
